...
mixin UiStateViewMixin {
  ...
  Widget handleUiState<T>( Rx<UiState<T>> observableState, Widget Function(T model) success,) {
    var stateValue = observableState.value;
    return _getWidgetOfUiState<T>(
        stateValue, success, loadingWidget, noInternetWidget, noDataWidget, errorWidget);
  }
  ...
  Widget _onLoading(UiState stateValue, Widget Function(LoadingType loadingType) loading) {
